        ...
        <ItemTemplate>
            ...
            <div id="topicContent">
                ...
                <div class="row" id="contentFooter">
                    <div class="col-sm-4"><p><%#: Item.CreatedOn %></p></div>
                    <div class="cols-sm-8"><p class="text-right"> Author:&nbsp <%#: Item.Author.UserName %> </p></div>
                </div>
            </div>
            </p>
        ...
        <ItemTemplate>
            <div class="row" id="commentContainer">
                <div class="row commentHeader">
                    ...
                    <div class="col-sm-8 text-right"><p>Author: <%#: Item.Author.UserName %></p></div>
                </div>

                <div class="row">
                    <div class="col-md-1"><img style="margin-top:10%;margin-left:4%" width="50px" height="50px"src="<%# getPath(Item.Author.UserName) %>" /></div>
                    <div class="col-md-11 commentText">
                        ...
                        <div class="row" style="padding-bottom:4px;padding-left:90%">
                            ...
                            <asp:LinkButton Height="25px" Width="60px" Visible="<%# (Item.UserId == Context.User.Identity.GetUserId()) || isAdmin %>" runat="server" ID="LinkButton3" CssClass="btn btn-danger " Text="Delete" OnClick="DeleteComment" />
                        </div>
                    </div>
                </div>                  
           </div>
